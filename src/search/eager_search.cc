...
EagerSearch::EagerSearch(
    ...
    m_ff_Heuristic = new FFHeuristic(opts);
}
...
void EagerSearch::initialize() {
    ...
    // PAC:
    // get ff initial heuristic value
    m_ff_Heuristic->evaluate(initial_state);
    m_init_ff_Heuristic_value = m_ff_Heuristic->get_heuristic();
    cout << "Initial ff_heuristic: " << m_init_ff_Heuristic_value << endl;
