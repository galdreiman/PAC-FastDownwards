...
public:
    ...
    virtual int evaluate_for_anytime(int g, bool preferred){if (preferred || !preferred) return g*0;}

    virtual void getFlattedOpenList(std::vector<Entry> &res){res.size();return;}
};
