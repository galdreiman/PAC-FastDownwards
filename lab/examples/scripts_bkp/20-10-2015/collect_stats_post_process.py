...
class collect_statistics(object):
	def __init__ (self):
		...
		head_line = ['algo','domain','problem' ,'optimal solution',	'PAC_condition','expanded','generated'	,'epsilon','delta','weight_search','search time(sec)', 'time_out']
...
if __name__ == '__main__':
	...
	cs.collect_stats()
	cs.write_to_file("/home/shahar/%s.csv" % os.environ["exp_name"] ) #os.environ["exp_name"])