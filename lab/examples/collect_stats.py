	...
	def collect_stats(self):
		...
		for dir in result_dirs:
			...
			for k in range(len(pac_condition)):
				#if k > 0:	
				new_row = ["AWA*", domain[0], problem[0], cost_all_data[0], "hstar_to_h", expansions_all_data[0], generated[0], epsilon, delta, weight_search, pac_ratio, pac_condition[k] if pac_condition else "None",len(pac_condition),k+1, search_time[0], time_out ]
...
if __name__ == '__main__':
	...
	cs.collect_stats()
	cs.write_to_file("/home/shahar/%s.csv" % os.environ["exp_name"])