...
class PlotReport(AbsoluteReport):
    """
    ...
    def _write_plot(self, domain, filename):
        # Map category names to coord tuples
        categories = self._fill_categories(domain)
...
class ProblemPlotReport(PlotReport):
    ...
    def _fill_categories(self, domain):
        categories = defaultdict(list)
        
        new_categories = self.get_points(domain)
